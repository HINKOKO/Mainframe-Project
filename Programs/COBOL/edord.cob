...
005000     .
009000 DEBUG.
009001     DISPLAY 'TP-PRICE   :' TP-PRICE
009002     DISPLAY 'WS-PRICE   :' WS-PRICE
009003     DISPLAY 'WS-QTY     :' WS-QTY
009004     DISPLAY 'WS-TOTAL   :' WS-TOTAL
009005     DISPLAY 'ED-TOTAL   :' ED-TOTAL
009006     .
...
009834     DISPLAY 'DANS ECRITURE BOTTOM'
...
009839     DISPLAY 'AC-TAX       :' AC-TAX
009840     DISPLAY 'WS-TAX    :' WS-TAX
009841     DISPLAY 'WS-TP-TAX    :' WS-TP-TAX
009842     DISPLAY 'WS-TOTAL-HT  :' WS-TOTAL-HT
009843     DISPLAY 'WS-TOTAL-TAX :' WS-TOTAL-TAX
009844     DISPLAY 'WS-TOTAL-TTC :' WS-TOTAL-TTC
009845     MOVE 'TOTAL HT'           TO L-TOT-TITLE
009846     MOVE WS-TOTAL-HT          TO L-TOT-DATA
009847     DISPLAY L-TOTAL
...
009854     DISPLAY 'WS-TAX * 100 :' WS-TAX
009855     DISPLAY 'ED-TAX       :' ED-TAX
009856     STRING
...
009873     DISPLAY 'WS-COM       :' WS-COM
009874     DISPLAY 'WS-TOTAL-COM :' WS-TOTAL-COM
009875     COMPUTE WS-COM = WS-COM * 100
009876     MOVE WS-COM TO ED-COM
009878     DISPLAY 'WS-COM * 100 :' WS-COM
009879     DISPLAY 'ED-COM       :' ED-COM
009880     STRING
...
009885     END-STRING
009886*    MOVE 'COMMISSION'          TO L-TOT-TITLE
009887     MOVE WS-TOTAL-COM         TO L-TOT-DATA
009888     DISPLAY L-TOTAL
