      ...
      *** STARTING TO WRITE ***
       ...
       STRINGIFY-DESIG-AND-VOLUME.
           STRING '          '      DELIMITED BY SIZE
                  '<DESIGNATION>'
                  PRO-DESCRIPTION-TEXT(1:PRO-DESCRIPTION-LEN)
       ...
       FETCH-ITEMS.
           ...
           EXEC SQL
             FETCH CITEMS
             INTO :ITE-P-NO, :PRO-DESCRIPTION, :IT-VOLUME
           END-EXEC
           PERFORM TEST-SQLCODE
           .
       ...
       SHOWCASE-SYSOUT.
           MOVE
              PRO-DESCRIPTION-TEXT(1:PRO-DESCRIPTION-LEN) TO ED-DESIG
           MOVE IT-VOLUME TO ED-VOLUME
           MOVE WS-RANK TO ED-RANK
           DISPLAY 'PRODUCT NUMBER: ' ITE-P-NO ' |'
