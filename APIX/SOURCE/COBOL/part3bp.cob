...
002521    05 FILLER  PIC X(30) VALUE ALL ' '.
...
002550    05 FILLER  PIC X(20) VALUE ALL ' '.
002551    05 FILLER  PIC X(3)  VALUE     '  |'.
002552
002553 01 L-CUS.
002554    05 FILLER       PIC X(3)  VALUE     '|  '.
002555    05 FILLER       PIC X(39) VALUE ALL ' '.
...
004872     WRITE ENR-FACT FROM L-TIRET-ITE BEFORE ADVANCING 1 LINE
004873     WRITE ENR-FACT FROM L-TITLE-ITE BEFORE ADVANCING 1 LINE
004874     WRITE ENR-FACT FROM L-TIRET-ITE BEFORE ADVANCING 1 LINE
004880     .
004890 WRITE-FACT-ITE-BOTTOM.
004900     DISPLAY L-TIRET-ITE
004910     WRITE ENR-FACT FROM L-TIRET-ITE BEFORE ADVANCING 1 LINE
009006     .
...
009035     WRITE ENR-FACT FROM L-ITE BEFORE ADVANCING 1 LINE
...
009501* COMPANY NAME
009510     WRITE ENR-FACT FROM L-TIRET-CUS BEFORE ADVANCING 1 LINE
009512     MOVE F-COMPANY   TO L-CUS-DATA
009513     DISPLAY L-CUS
009514     WRITE ENR-FACT FROM L-CUS BEFORE ADVANCING 1 LINE
009515* COMPANY ADDRESS
009518     MOVE F-ADDRESS   TO L-CUS-DATA
009519     DISPLAY L-CUS
009520     WRITE ENR-FACT FROM L-CUS BEFORE ADVANCING 1 LINE
...
009532     WRITE ENR-FACT FROM L-CUS BEFORE ADVANCING 1 LINE
009533* COMPANY STATE
009534     PERFORM CALL-SSP-STATE
009535     MOVE LS-ST-NAME  TO L-CUS-DATA
009537     DISPLAY L-CUS
009538     WRITE ENR-FACT FROM L-CUS BEFORE ADVANCING 1 LINE
009539     DISPLAY L-TIRET-CUS
009540     WRITE ENR-FACT FROM L-TIRET-CUS BEFORE ADVANCING 1 LINE
009542     MOVE SPACES TO F-STATE
009543     .
009561 CLEAN-L-EMP.
009565     MOVE SPACES TO L-EMP-DATA
009566     MOVE SPACES TO ED-CONTACT
009567     .
009570 CLEAN-L-ITE.
...
009612     WRITE ENR-FACT FROM L-DATE BEFORE ADVANCING 1 LINE
...
009705     WRITE ENR-FACT FROM L-ORD BEFORE ADVANCING 1 LINE
009706     MOVE 'ORDER DATE :' TO L-ORD-TITLE
009707     MOVE F-O-DATE TO L-ORD-DATA
009708     DISPLAY L-ORD
009709     WRITE ENR-FACT FROM L-ORD BEFORE ADVANCING 1 LINE
...
009815          'otre contact au departement ' delimited by size
...
009825     WRITE ENR-FACT FROM L-EMP-UNE-LIGNE BEFORE ADVANCING 1 LINE
...
009848     WRITE ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009849     WRITE ENR-FACT FROM L-TOTAL BEFORE ADVANCING 1 LINE
009850     WRITE ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
...
009865     WRITE ENR-FACT FROM L-TOTAL BEFORE ADVANCING 1 LINE
009866     WRITE ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
...
009889     WRITE ENR-FACT FROM L-TOTAL BEFORE ADVANCING 1 LINE
009890     WRITE ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009891     MOVE 'TOTAL TTC'          TO L-TOT-TITLE
009892     MOVE WS-TOTAL-TTC         TO L-TOT-DATA
009894     WRITE ENR-FACT FROM L-TOTAL BEFORE ADVANCING 1 LINE
009895     WRITE ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009896     WRITE ENR-FACT FROM L-TIRET BEFORE ADVANCING PAGE
009897     .
009898 WRITE-FACT-TOP.
009899     WRITE   ENR-FACT FROM L-TIRET BEFORE ADVANCING 1 LINE
009900     WRITE   ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009903     PERFORM WRITE-FACT-CUS
009904     PERFORM WRITE-FACT-DAT
009905     WRITE   ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009906     PERFORM WRITE-FACT-ORD
009907     PERFORM WRITE-FACT-EMP
009908     WRITE   ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009909     WRITE   ENR-FACT FROM L-VIDE BEFORE ADVANCING 1 LINE
009910     .
009911 INIT-ORDER.
