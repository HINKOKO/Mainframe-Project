...
SELECT
    C.C_NO,
    P.P_NO AS Numéro_produit,
    SUM(I.QUANTITY) AS Total
FROM
    API2.CUSTOMERS C
JOIN
    API2.ORDERS O ON C.C_NO = O.C_NO
JOIN
    API2.ITEMS I ON O.O_NO = I.O_NO
JOIN
    API2.PRODUCTS P ON I.P_NO = P.P_NO
WHERE
    O.O_NO > 500  -- ATTENTION ! dernières commandes uniquement
GROUP BY
    C.C_NO, P.P_NO
ORDER BY
    C.C_NO
